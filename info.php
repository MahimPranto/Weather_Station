<?php 
	...
	if(isset($_POST["submit"])){
		...
		$url="http://api.openweathermap.org/data/2.5/weather?q=".$selection."&lang=en&units=metric&appid=ffef9fb42805ece0271208e0e9c02a90";
			if(validateUrl($url)){
					...
					$url="https://api.openweathermap.org/data/2.5/onecall?lat=".$lat."&lon=".$lon."&units=metric&%20exclude=hourly,daily&appid=ffef9fb42805ece0271208e0e9c02a90";	
